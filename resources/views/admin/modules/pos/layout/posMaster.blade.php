...
<head>
    ...
    <link rel="icon" href="{{ asset('/')}}adminih/defaultIcon/icon.png" />
    <!--bootstrap-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="navbar" style="padding:1px;">
        <a class="navbar-brand" style="padding:0px;" href="{{route('admin.dashboard')}}"> <img src="{{ asset('/')}}adminih/defaultIcon/logo.png" class="img-fluid" style="width:170px;height: 50px;" alt="skilldigger"></a>
