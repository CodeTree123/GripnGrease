						...
						<tbody>
							...
							<tr>
								...
								<td style="width:120px;">
									...
									<button class="btn btn-success p-1 px-2 mb-0 v-btn viewBillerbtn"  style="font-size: 13px;cursor:pointer;" title="User Details" value="{{$biller->id}}"> <i class="fa-fw fa fa-eye"></i></button>
									<button class="btn btn-info p-1 mb-0 px-2 edit-btn editBillerbtn" value="{{$biller->id}}" style="font-size: 13px;cursor:pointer;" title="Edit User"> <i class="fa fa-edit" ></i></button>
