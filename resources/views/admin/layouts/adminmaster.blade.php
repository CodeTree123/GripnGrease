...
<head>
	...
	<meta name="csrf-token" content="{{ csrf_token() }}">
	 <link href="{{ asset('frontEnd/images/icon.png') }}" rel="shortcut icon"/>	<!--bootstrap-->
	<link rel="stylesheet" type="text/css" href="{{asset('/')}}adminih/asset/css/bootstrap.min.css">
	<link rel="stylesheet" type="text/css" href="{{asset('/')}}adminih/asset/css/all.min.css">
	<!--dropdown plugin-->
	<link rel="stylesheet" type="text/css" href="{{asset('/')}}adminih/asset/css/animate.min.css">
	<link rel="stylesheet" type="text/css" href="{{asset('/')}}adminih/asset/css/bootnavbar.css">

	<!--fontawesome-->
	<link rel="stylesheet" href="{{asset('/')}}adminih/asset/css/font-awesome.min.css">
	<!--Tostr-->
	<link rel="stylesheet" type="text/css" href="{{asset('/')}}adminih/asset/css/toastr.min.css">
	<!--customised css file-->
	<link rel="stylesheet" type="text/css" href="{{asset('/')}}adminih/asset/css/style.css">


	<!--Select 2-->
	<link href="{{asset('/')}}adminih/asset/css/select2.min.css" rel="stylesheet" />
	<!--Morris chart-->
	<link href="{{asset('/')}}adminih/asset/css/morris.css" rel="stylesheet" />

	<title>
		@yield('adminTitle')
	</title>
	<script src="{{asset('/')}}adminih/asset/js/jquery-3.4.1.min.js"></script>
	<script>
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="navbar" style="padding:1px;background-color: #7e8082!important;">
		<a class="navbar-brand" style="padding:0px;" href="{{route('admin.dashboard')}}"> <img src="{{ asset('frontEnd/images/logo.png') }}" class="img-fluid" style="" alt="skilldigger"></a>
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item dropdown">
					<a class="nav-link" href="#" data-toggle="dropdown" id="user-profile">
						...
						<img src="{{asset('/')}}adminih/defaultIcon/user.png">
...
<script src="{{asset('/')}}adminih/asset/js/popper.min.js"></script>
<script src="{{asset('/')}}adminih/asset/js/bootstrap.min.js"></script>
<!--dropdown plugin file-->
<script src="{{asset('/')}}adminih/asset/js/bootnavbar.js"></script>
<script src="{{asset('/')}}adminih/asset/js/all.min.js"></script>
<script src="{{asset('/')}}adminih/asset/js/main.js"></script>
<!--select 2-->
<script src="{{asset('/')}}adminih/asset/js/select2.min.js"></script>
...
<script src="{{asset('/')}}adminih/asset/js/toastr.min.js"></script>
{!! Toastr::message() !!}
<script>
	@if(count($errors) > 0)
