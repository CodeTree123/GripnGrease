					...
					<table class="table table-bordered table-hover">
						...
						<tbody id="table-data">
                                ...
                                <tr>
									...
									<!-- <button class="btn btn-success p-1 px-2 mb-0 v-btn"  style="font-size: 13px;cursor:pointer;" title="User Details" value="{{$web->id}}"> <i class="fa-fw fa fa-eye"></i></button> -->
									<button class="btn btn-info p-1 mb-0 px-2 edit-btn" value="{{$web->id}}" style="font-size: 13px;cursor:pointer;" title="Edit User"> <i class="fa fa-edit" ></i></button>
									...
									<p class="btn btn-danger mb-0 p-1 px-2 del-btn <?php echo 'btn'.$key?>" style="font-size: 13px;relative;cursor:pointer;" title="Delete user"> <i class="fa fa-trash"></i></p>
									</td>
                                </tr>
							@endforeach
						</tbody>
