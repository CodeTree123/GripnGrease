...
<head>
    ...
    <!--fontawesome-->
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}adminih/asset/css/fontawesome.min.css">
    <!--customised css file-->
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}adminih/asset/css/style.css">
    <title>Login -Admin Panel</title>
</head>
<body class="form-body" style="background-image:url('frontEnd/images/b2.jpg');background-repeat: no-repeat;background-size: cover; ">
